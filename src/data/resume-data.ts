...
export const leftColumnData: LeftColumnData = {
    ...
    skills: [
        {'info':'熟练掌握java基础知识，理解面向对象编程。', 'page':1},
        {'info':'了解基本数据类型，以及掌握java中常见数据类型原理及用法。', 'page':1},
        {'info':'理解基本算法，能对常见问题给出较简洁的算法代码。', 'page':1},
        {'info':'熟悉java8 stream编程，能够通过阅读源码掌握java常见类原理与使用方法。', 'page':1},
        {'info':'熟悉javaee开发，掌握ssm及springboot开发，理解其简单实现原理。', 'page':1},
        {'info':'掌握spring bean的加载方法以及spring boot自动配置，能够使用spring boot开发出扩展良好，灵活的产品项目或者插件。', 'page':2},
        {'info':'掌握python语言，可使用python开发各种小工具（包括桌面端 pyqt5）', 'page':2},
        {'info':'掌握sklearn工具包使用，掌握pytorch使用以及计算机视觉算法', 'page':2},
        {'info':'完整学习过c语言，可使用c语言开发小工具。', 'page':2},
        {'info':'掌握linux系统，并且生活工作中使用linux系统（前期centos，后期转投debian）', 'page':2},
        {'info':'掌握javascript语言，可使用nodejs开发各种工具插件，可以使用vue开发前端项目', 'page':2},
        {'info':'支持并参与开源项目，在github上开源多个项目。', 'page':2}
    ],
...
export const rightColumnData: RightColumnData = {
    ...
    workExperience: [
        ...
        },
        {
            ...
            description: 
                '负责MES项目后端主开发，MES项目核心业务，接口，算法开发，负责项目实施方案的确定，PDA技术选型等。MES项目使用C#语言开发，C/S架构，C端包含WPF开发的windows桌面客户端，VUE架构开发浏览器端，和PDA端，服务端使用WCF技术开发。'
            ,
        ...
        },
        {
            ...
            description: 
                '大连高端仙岛智能科技有限公司是一家专注于煤矿智慧安全监测监控系统、应急救援系统、人机精准定位系统的高科技工业物联网企业。参与的项目主要公司门户网站开发，人员定位系统开发，gis项目以及其他一些小项目。',
    ...
    projects: [
        {
            ...
            position: '产品开发',
            description: 
                '负责WMS智能库的产品开发，期间产品从无到有，在诸多凌乱项目中整理一套相对合理的业务逻辑，对数据库表重新设计，减少冗余字段。期间架构做了三次升级，从最初的一个项目包含所有到后面分模块分组件开发，现产品已做成可插拔支持多种业务模式，可支持高度定值化开发。'
            ,
